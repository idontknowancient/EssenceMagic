...
public enum Permission {
    ...
    COMMAND_MAGIC_APTITUDE_REMOVE("command.magic.aptitude.remove"),
    ...
    COMMAND_MAGIC_DOMAIN_REMOVE("command.magic.domain.remove"),
    ...
    COMMAND_MAGIC_SIGNET_REMOVE("command.magic.signet.remove"),
