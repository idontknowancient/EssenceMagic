...
public enum SystemMessage implements Message {
    ...
    MAGIC_APTITUDE_GOT("magic-aptitude-got"),
    MAGIC_APTITUDE_GAVE("magic-aptitude-gave"),
    MAGIC_APTITUDE_NOT_FOUND("magic-aptitude-not-found"),
    MAGIC_APTITUDE_REMOVED("magic-aptitude-removed"),
    MAGIC_APTITUDE_RESET("magic-aptitude-reset"),
    MAGIC_DOMAIN_GOT("magic-domain-got"),
    MAGIC_DOMAIN_GAVE("magic-domain-gave"),
    MAGIC_DOMAIN_NOT_FOUND("magic-domain-not-found"),
    MAGIC_DOMAIN_REMOVED("magic-domain-removed"),
    MAGIC_SIGNET_GOT("magic-signet-got"),
    MAGIC_SIGNET_GAVE("magic-signet-gave"),
    MAGIC_SIGNET_NOT_FOUND("magic-signet-not-found"),
    MAGIC_SIGNET_REMOVED("magic-signet-removed"),
